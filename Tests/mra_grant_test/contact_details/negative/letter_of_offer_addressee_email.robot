...
*** Variables ***
${EMAIL ELEM}       xpath://div[contains(@class,'bgp-questions-grp')]/div/div[3]//label[text()="Email"]/ancestor::div[@class='form-group']//input

*** Test Cases ***
Letter Of Offer Addressee - Email should show warning for emails with ${invalid_scenario}
    [Tags]  negative
